...
- [Search our issue
  tracker](https://github.com/manifoldco/cheaters-graphql/issues/search&type=issues)
...
`cheaters-graphql`, commit your changes, and [open a pull
...
Manifold's cheaters-graphql is released under the [BSD 3-Clause
License](../LICENSE.md).
...
agreement](https://cla-assistant.io/manifoldco/cheaters-graphql), either for an
